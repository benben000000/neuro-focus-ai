...
export const MemberSidebar: React.FC<MemberSidebarProps> = ({ members }) => {
    ...
    const renderMember = (member: GroupMember & Partial<UserProfile>) => (
        <div key={member.userId} className="flex items-center gap-3 px-2 py-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded transition-colors cursor-pointer opacity-90 hover:opacity-100">
